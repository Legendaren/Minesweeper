...
const EMPTY_REVEALED_REGION : Rect2 = Rect2(Vector2(4, 4), Vector2(16, 16))
const ONE_REGION : Rect2 = Rect2(Vector2(20, 4), Vector2(16, 16))
const TWO_REGION : Rect2 = Rect2(Vector2(36, 4), Vector2(16, 16))
const THREE_REGION : Rect2 = Rect2(Vector2(52, 4), Vector2(16, 16))
const FOUR_REGION : Rect2 = Rect2(Vector2(4, 20), Vector2(16, 16))
const FIVE_REGION : Rect2 = Rect2(Vector2(20, 20), Vector2(16, 16))
const SIX_REGION : Rect2 = Rect2(Vector2(36, 20), Vector2(16, 16))
const SEVEN_REGION : Rect2 = Rect2(Vector2(52, 20), Vector2(16, 16))
const EIGHT_REGION : Rect2 = Rect2(Vector2(68, 20), Vector2(16, 16))
const EMPTY_HIDDEN_REGION : Rect2 = Rect2(Vector2(20, 36), Vector2(16, 16))
const FLAG_REGION : Rect2 = Rect2(Vector2(36, 36), Vector2(16, 16))
const MINE_REGION : Rect2 = Rect2(Vector2(4, 52), Vector2(16, 16))
